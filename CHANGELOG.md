...
- **safari:** fix an issue where ResizeObserver is detected as supported by Safari (it is an experimental opt-in feature) ([6492c07](https://github.com/wessberg/browserslist-generator/commit/6492c07))
...
- **browsers:** adds support for parsing SamsungBrowser 8.2 ([a6b3217](https://github.com/wessberg/browserslist-generator/commit/a6b3217))
...
- Added a few new functions: 'getAppropriateEcmaVersionForBrowserslist', 'browserslistSupportsEcmaVersion', and 'browsersWithSupportForEcmaVersion' ([8173687](https://github.com/wessberg/browserslist-generator/commit/8173687))
